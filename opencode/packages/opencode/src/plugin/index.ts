...
import { ForgeVerifyPlugin } from "./forge-verify"
...
const INTERNAL_PLUGINS: PluginInstance[] = [
  ...
  XaiAuthPlugin,
  // ForgeVerifyPlugin is a no-op unless FORGE_PROJECT_ID is set in the
  // environment — so non-Forge opencode users are completely unaffected.
  ForgeVerifyPlugin,
]
