export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Forge UI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Forge UI-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Forge UI Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Forge UI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Forge UI-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Forge UI server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Forge UI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Forge UI timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Forge UI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Forge UI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Forge UI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Forge UI-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Forge UI izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Forge UI prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Forge UI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Forge UI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Forge UI-a.",
