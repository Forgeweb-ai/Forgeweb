export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Forge UIが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Forge UIで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Forge UI Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してForge UIで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Forge UIで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するForge UIサーバーを切り替えます。",
  ...
  "toast.update.description": "Forge UIの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをForge UIチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: Forge UIはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Forge UIには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でForge UIサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Forge UIの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのForge UIの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Forge UIがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Forge UIのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Forge UI の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Forge UI は最新バージョンです。",
