...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Forge UI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Forge UI.",
  ...
  "provider.connect.opencodeZen.line1":
    "Forge UI Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Forge UI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Forge UI.",
  ...
  "dialog.server.description": "Bytt hvilken Forge UI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Forge UI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Forge UI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Forge UI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Forge UI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Forge UI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Forge UI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Forge UI ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Forge UI skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Forge UI er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Forge UI starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Forge UI.",
