...
import { SessionImageDock } from "@/pages/session/composer/session-image-dock"
...
export function SessionComposerRegion(props: {
  ...
  return (
    ...
    >
      ...
      >
        {/*
          Per-turn telemetry strip — sits directly below the chat timeline.
        ...
        */}
        ...
        <Show when={showComposer()}>
          ...
          >
            ...
            {/* Image-gen status chip. Self-derives the projectId from the
                SDK directory and polls forge-server only when jobs are in
                flight — flat per-session cost, zero when feature is off. */}
            <SessionImageDock />
            <Show when={rolled()} keyed>
              {(revert) => (
                <div
