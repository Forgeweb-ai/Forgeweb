        ...
        <div class="flex-1 min-h-0 w-full">
          ...
          >
            ...
            <div class="h-full w-full flex flex-col items-center gap-3 px-3 py-3 overflow-y-auto no-scrollbar">
              {/* Home — always visible in the collapsed rail so the user can
                  jump to the project picker without having to expand first. */}
              <Tooltip placement={placement()} value={props.homeLabel()}>
                ...
                >
                  <svg
                    ...
                    data-slot="icon-svg"
                  >
                    <path d="M2.5 9.16 10 2.5l7.5 6.66" />
                    <path d="M4.16 8.33v8.34h11.66V8.33" />
                  </svg>
                </button>
              </Tooltip>
