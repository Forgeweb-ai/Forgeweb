export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Forge UI",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Forge UI.",
  ...
  "provider.connect.opencodeZen.line1":
    "Forge UI Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Forge UI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Forge UI.",
  ...
  "dialog.server.description": "Перемкніть сервер Forge UI, до якого підключається ця програма.",
  ...
  "toast.update.description": "Нова версія Forge UI ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Forge UI",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Forge UI ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Forge UI містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Forge UI всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Forge UI",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Forge UI на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Forge UI використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Forge UI.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Forge UI",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Forge UI.",
