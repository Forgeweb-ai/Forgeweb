export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Forge UI",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Forge UI.",
  ...
  "provider.connect.opencodeZen.line1":
    "Forge UI Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Forge UI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Forge UI.",
  ...
  "dialog.server.description": "Переключите сервер Forge UI к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия Forge UI ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Forge UI",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Forge UI пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Forge UI включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Forge UI внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Forge UI",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Forge UI выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Forge UI системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Forge UI.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Forge UI",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Forge UI.",
