export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Forge UI",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Forge UI.",
  ...
  "provider.connect.opencodeZen.line1":
    "Forge UI Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Forge UI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Forge UI.",
  ...
  "dialog.server.description": "Changez le serveur Forge UI auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Forge UI ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Forge UI",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Forge UI ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Forge UI inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "Forge UI Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Forge UI dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Forge UI",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Forge UI sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Forge UI suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Forge UI.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Forge UI",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Forge UI.",
