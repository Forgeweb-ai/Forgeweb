export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Forge UI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Forge UI.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Forge UI Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Forge UI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Forge UI.",
  ...
  "dialog.server.description": "Switch which Forge UI server this app connects to.",
  ...
  "toast.update.description": "A new version of Forge UI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Forge UI team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Forge UI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Forge UI includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Forge UI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Forge UI",
  ...
  "settings.general.row.appearance.description": "Customise how Forge UI looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Forge UI follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Forge UI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Forge UI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Forge UI.",
